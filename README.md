...
Optické jevy způsobené posuny čoček při zobrazení paprsků aproximujeme natočením kužele, což může při akumulaci čoček s extrémní hodnotou posuvu (nebo menší, ale v bodě kdy je paprsek úzký a při jeho zvětšení dojde k znásobení chyby) vést k zvláštně vypadajícímu mikroskopu - zde jsme omezení nedostatkem složitějších tvarů než je kužel nebo natočený kužel. 
